...
import { jstToday, addDays, toDisplayDate, isYmd } from '../../core/dates.js';
    ...
    page({
      ...
      body: html`
        ...
        <div class="scroll-x"><table>
          ...
          ${raw(body || '<tr><td colspan="9">この期間の予定はありません。</td></tr>')}
        </table></div>

        <p><a class="btn" href="/admin/timeline">タイムラインで見る</a></p>
      `
    })
  );
}
